...
// MockChain template op: returns {out0, out1}. See MockChainParam / CPUMockChain.
MNN_PUBLIC std::vector<VARP> _MockChain(VARP a, VARP b, float offset0 = 10.0f, float offset1 = 20.0f);
