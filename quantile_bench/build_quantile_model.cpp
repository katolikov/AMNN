...
// for this benchmark). Usage: build_quantile_model <outPath> [N] [numQLevels] [u8]
...
// pass "u8" as a 4th arg to set assumeUint8Source=true, exercising the
// single-pass 256-bucket-histogram fast path instead of the general path).
#include <cstdlib>
#include <cstring>
...
int main(int argc, char** argv) {
    ...
    const bool assumeUint8Source = argc > 4 && strcmp(argv[4], "u8") == 0;
    ...
    auto y = _Quantile(x, std::move(qLevels), assumeUint8Source);
    y->setName("quantiles");
