...
struct Convolution2DCommonT : public flatbuffers::NativeTable {
  ...
  bool hasOutputShape;
  std::vector<float> leakyReluSlope;
...
struct Convolution2DCommon FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<float> *leakyReluSlope() const {
    return GetPointer<const flatbuffers::Vector<float> *>(38);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, 38) &&
           verifier.VerifyVector(leakyReluSlope()) &&
           verifier.EndTable();
  }
...
struct Convolution2DCommonBuilder {
  ...
  void add_leakyReluSlope(flatbuffers::Offset<flatbuffers::Vector<float>> leakyReluSlope) {
    fbb_.AddOffset(38, leakyReluSlope);
  }
...
inline flatbuffers::Offset<Convolution2DCommon> CreateConvolution2DCommon(
    ...
    flatbuffers::Offset<flatbuffers::Vector<float>> leakyReluSlope = 0) {
  Convolution2DCommonBuilder builder_(_fbb);
  builder_.add_leakyReluSlope(leakyReluSlope);
...
inline void Convolution2DCommon::UnPackTo(Convolution2DCommonT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = leakyReluSlope(); if (_e) { _o->leakyReluSlope.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->leakyReluSlope[_i] = _e->Get(_i); } } };
}
...
inline flatbuffers::Offset<Convolution2DCommon> CreateConvolution2DCommon(flatbuffers::FlatBufferBuilder &_fbb, const Convolution2DCommonT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _leakyReluSlope = _o->leakyReluSlope.size() ? _fbb.CreateVector(_o->leakyReluSlope) : 0;
