...
inline const char *EnumNameOpType(OpType e) {
  if (e < OpType_AbsVal || e > OpType_Quantile) return "";
...
enum OpParameter {
  ...
  OpParameter_QuantileParam = 102,
  OpParameter_MIN = OpParameter_NONE,
  OpParameter_MAX = OpParameter_QuantileParam
};
...
inline const char *EnumNameOpParameter(OpParameter e) {
  if (e < OpParameter_NONE || e > OpParameter_QuantileParam) return "";
  const size_t index = static_cast<int>(e);
...
template<> struct OpParameterTraits<QuantileParam> {
  static const OpParameter enum_value = OpParameter_QuantileParam;
};
...
struct OpParameterUnion {
  ...
  QuantileParamT *AsQuantileParam() {
    return type == OpParameter_QuantileParam ?
      reinterpret_cast<QuantileParamT *>(value) : nullptr;
  }
  const QuantileParamT *AsQuantileParam() const {
    return type == OpParameter_QuantileParam ?
      reinterpret_cast<const QuantileParamT *>(value) : nullptr;
  }
};
...
struct QuantileParam FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef QuantileParamT NativeTableType;
  static const flatbuffers::TypeTable *MiniReflectTypeTable() {
    return QuantileParamTypeTable();
  }
  ...
  void UnPackTo(QuantileParamT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<QuantileParam> Pack(flatbuffers::FlatBufferBuilder &_fbb, const QuantileParamT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct QuantileParamBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  ...
  QuantileParamBuilder &operator=(const QuantileParamBuilder &);
  flatbuffers::Offset<QuantileParam> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<QuantileParam>(end);
    return o;
  }
};
...
flatbuffers::Offset<QuantileParam> CreateQuantileParam(flatbuffers::FlatBufferBuilder &_fbb, const QuantileParamT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct Op FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const QuantileParam *main_as_QuantileParam() const {
    return main_type() == OpParameter_QuantileParam ? static_cast<const QuantileParam *>(main()) : nullptr;
  }
...
template<> inline const QuantileParam *Op::main_as<QuantileParam>() const {
  return main_as_QuantileParam();
}
...
inline QuantileParamT *QuantileParam::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = new QuantileParamT();
  UnPackTo(_o, _resolver);
  return _o;
}

inline void QuantileParam::UnPackTo(QuantileParamT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
...
inline flatbuffers::Offset<QuantileParam> QuantileParam::Pack(flatbuffers::FlatBufferBuilder &_fbb, const QuantileParamT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateQuantileParam(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<QuantileParam> CreateQuantileParam(flatbuffers::FlatBufferBuilder &_fbb, const QuantileParamT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
...
inline bool VerifyOpParameter(flatbuffers::Verifier &verifier, const void *obj, OpParameter type) {
  switch (type) {
    ...
    case OpParameter_QuantileParam: {
      auto ptr = reinterpret_cast<const QuantileParam *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline flatbuffers::Offset<void> OpParameterUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    ...
    case OpParameter_QuantileParam: {
      auto ptr = reinterpret_cast<const QuantileParamT *>(value);
      return CreateQuantileParam(_fbb, ptr, _rehasher).Union();
    }
    default: return 0;
  }
}
...
inline OpParameterUnion::OpParameterUnion(const OpParameterUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case OpParameter_QuantileParam: {
      value = new QuantileParamT(*reinterpret_cast<QuantileParamT *>(u.value));
      break;
    }
    default:
      break;
...
inline void OpParameterUnion::Reset() {
  switch (type) {
    ...
    case OpParameter_QuantileParam: {
      auto ptr = reinterpret_cast<QuantileParamT *>(value);
      delete ptr;
      break;
    }
    default: break;
