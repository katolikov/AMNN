...
struct ApplyLUTParam;
struct ApplyLUTParamT;
...
inline const flatbuffers::TypeTable *ApplyLUTParamTypeTable();
...
inline const char *EnumNameOpType(OpType e) {
  if (e < OpType_AbsVal || e > OpType_ApplyLUT) return "";
...
enum OpParameter {
  ...
  OpParameter_ApplyLUTParam = 102,
  OpParameter_MIN = OpParameter_NONE,
  OpParameter_MAX = OpParameter_ApplyLUTParam
};
...
inline const char *EnumNameOpParameter(OpParameter e) {
  if (e < OpParameter_NONE || e > OpParameter_ApplyLUTParam) return "";
  const size_t index = static_cast<int>(e);
...
template<> struct OpParameterTraits<ApplyLUTParam> {
  static const OpParameter enum_value = OpParameter_ApplyLUTParam;
};
...
struct OpParameterUnion {
  ...
  ApplyLUTParamT *AsApplyLUTParam() {
    return type == OpParameter_ApplyLUTParam ?
      reinterpret_cast<ApplyLUTParamT *>(value) : nullptr;
  }
  const ApplyLUTParamT *AsApplyLUTParam() const {
    return type == OpParameter_ApplyLUTParam ?
      reinterpret_cast<const ApplyLUTParamT *>(value) : nullptr;
  }
};
...
struct ApplyLUTParamT : public flatbuffers::NativeTable {
  typedef ApplyLUTParam TableType;
  int32_t interp;
  ApplyLUTParamT()
      : interp(1) {
  }
...
struct ApplyLUTParam FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ApplyLUTParamT NativeTableType;
  static const flatbuffers::TypeTable *MiniReflectTypeTable() {
    return ApplyLUTParamTypeTable();
  }
  int32_t interp() const {
    return GetField<int32_t>(4, 1);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, 4) &&
  ...
  ApplyLUTParamT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(ApplyLUTParamT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<ApplyLUTParam> Pack(flatbuffers::FlatBufferBuilder &_fbb, const ApplyLUTParamT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct ApplyLUTParamBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_interp(int32_t interp) {
    fbb_.AddElement<int32_t>(4, interp, 1);
  }
  explicit ApplyLUTParamBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ApplyLUTParamBuilder &operator=(const ApplyLUTParamBuilder &);
  flatbuffers::Offset<ApplyLUTParam> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ApplyLUTParam>(end);
    return o;
  }
};

inline flatbuffers::Offset<ApplyLUTParam> CreateApplyLUTParam(
    flatbuffers::FlatBufferBuilder &_fbb,
    int32_t interp = 1) {
  ApplyLUTParamBuilder builder_(_fbb);
  builder_.add_interp(interp);
  return builder_.Finish();
}

flatbuffers::Offset<ApplyLUTParam> CreateApplyLUTParam(flatbuffers::FlatBufferBuilder &_fbb, const ApplyLUTParamT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct Op FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const ApplyLUTParam *main_as_ApplyLUTParam() const {
    return main_type() == OpParameter_ApplyLUTParam ? static_cast<const ApplyLUTParam *>(main()) : nullptr;
  }
...
template<> inline const ApplyLUTParam *Op::main_as<ApplyLUTParam>() const {
  return main_as_ApplyLUTParam();
}
...
inline ApplyLUTParamT *ApplyLUTParam::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = new ApplyLUTParamT();
  UnPackTo(_o, _resolver);
  return _o;
}

inline void ApplyLUTParam::UnPackTo(ApplyLUTParamT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = interp(); _o->interp = _e; };
}

inline flatbuffers::Offset<ApplyLUTParam> ApplyLUTParam::Pack(flatbuffers::FlatBufferBuilder &_fbb, const ApplyLUTParamT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateApplyLUTParam(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<ApplyLUTParam> CreateApplyLUTParam(flatbuffers::FlatBufferBuilder &_fbb, const ApplyLUTParamT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const ApplyLUTParamT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _interp = _o->interp;
  return MNN::CreateApplyLUTParam(
      _fbb,
      _interp);
}
...
inline bool VerifyOpParameter(flatbuffers::Verifier &verifier, const void *obj, OpParameter type) {
  switch (type) {
    ...
    case OpParameter_ApplyLUTParam: {
      auto ptr = reinterpret_cast<const ApplyLUTParam *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline flatbuffers::Offset<void> OpParameterUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    ...
    case OpParameter_ApplyLUTParam: {
      auto ptr = reinterpret_cast<const ApplyLUTParamT *>(value);
      return CreateApplyLUTParam(_fbb, ptr, _rehasher).Union();
    }
    default: return 0;
  }
}
...
inline OpParameterUnion::OpParameterUnion(const OpParameterUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case OpParameter_ApplyLUTParam: {
      value = new ApplyLUTParamT(*reinterpret_cast<ApplyLUTParamT *>(u.value));
      break;
    }
    default:
      break;
...
inline void OpParameterUnion::Reset() {
  switch (type) {
    ...
    case OpParameter_ApplyLUTParam: {
      auto ptr = reinterpret_cast<ApplyLUTParamT *>(value);
      delete ptr;
      break;
    }
    default: break;
