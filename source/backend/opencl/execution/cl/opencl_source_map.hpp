...
const std::map<std::string, std::string> OpenCLProgramMd5Map = 
 { 
  ...
  { "winogradTransform_buf", "9671a991414cd1623bbca4b828fca97e" },
  ...
  { "winogradTransformDest2_3_1", "61ecea717f30c14f8173a753229726fd" },
  ...
  { "winogradTransformDest2_5_1", "e1288539b8df83c3b0330f954d6a7ab7" },
