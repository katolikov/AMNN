...
const std::map<std::string, std::string> OpenCLProgramMd5Map = 
 { 
  ...
  { "winogradTransform_buf", "5520a3d5a10306c08b3ded101b0be6b8" },
  ...
  { "conv_2d_buf", "647552024185ab232cd691473776213f" },
  { "gemm_int", "41770c2a12943f8fbdbfe259889ddf2d" },
  { "buffer_to_image", "bad95040692206db84b5a1bcc0b6f248" },
  { "winogradTransformDest2_3_1", "acc12847d65d0036fae8d186f10d0440" },
  ...
  { "winogradTransformDest2_5_1", "8a1f9faa4501d494b7741ac77c4c86b0" },
